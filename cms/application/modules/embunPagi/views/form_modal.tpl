	...
	<div class="md-card uk-height-viewport">
	    ...
	    <div class="md-card-toolbar">
	        <div class="md-card-toolbar-actions">
                <i class="md-icon material-icons uk-text-success form-submit" data-target="#form-ep">&#xE161;</i>
	    ...
	    <div class="md-card-content uk-margin-large-bottom large-padding">
	    	<form id="form-ep" method="post" action="{$action_url}">
	    		<input type="hidden" name="key" value="qwerty"/>
	    		{if $action == 'edit'}
	    		<input type="hidden" name="ep_id" value="{$data['ep_id']}"/>
	    		{/if}
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$('.selectku').selectize();
		custom_scripts.form_validate('#form-ep');
	});
	{/literal}
</script>