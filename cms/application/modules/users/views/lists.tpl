...
<div id="page_heading" data-uk-sticky="{ top: 48, media: 960 }">
	<div class="heading_actions">
        <a href="javascript:;" class="md-btn md-btn-success md-btn-small md-btn-wave-light md-btn-icon open-modal" data-url="{base_url('public/users/add')}">
    ...
    <h1>{$title}</h1>
    <span class="uk-text-upper uk-text-small"><a href="{base_url()}public/users/">{$sub_title}</a></span>
</div>
	...
	<div class="md-card uk-margin-large-bottom">
	    ...
	    <div class="md-card-content">
	    	...
	    	<div class="uk-overflow-container uk-margin-large-bottom table-container">
	    		<form id="form-bulk-delete" method="post" action="{base_url()}public/users/bulk_delete">
			        <table class="uk-table uk-text-nowrap uk-table-striped tbl_ajax table_check" data-url="{base_url()}public/users/lists_ajax" data-disable-sorting="[0,1,5]"
			        data-default-column-sorting="4" data-default-dir-sorting="desc">
			            <thead>
			                ...
			                <tr class="filter">
			            		...
			            		<td></td>
			            		<td>
			            			<input type="text" name="username" class="md-input uk-form-width-medium form-filter" placeholder="username" />
			            		</td>
			            		<td>
